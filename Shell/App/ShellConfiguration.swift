...
enum ShellConfiguration {
    ...
    static let supportedLanguages: [AppLanguage] = [
        ...
        .init(id: "pt", displayName: "Português (Brasil)"),
        ...
        .init(id: "ro", displayName: "Română"),
        .init(id: "cs", displayName: "Čeština"),
        .init(id: "uk", displayName: "Українська"),
        ...
        .init(id: "nb", displayName: "Norsk bokmål"),
        .init(id: "el", displayName: "Ελληνικά"),
        .init(id: "he", displayName: "עברית"),
    ]
}
